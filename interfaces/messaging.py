...
Unified Messaging Interface for ATHENA multi-platform bots.

Provides:
- Command parsing (/goal, /status, /ATHENA, etc.)
...
class MessagingInterface:
    ...
    CMD_REGEX = re.compile(r"^/(goal|status|stop|ATHENA|help|swarm|claw)\s*(.*)$", re.IGNORECASE)
