...
Allows any part of ATHENA (orchestrator, agents, ATHENA) to emit events
...
class DashboardEventBroadcaster:
    ...
    def metrics_update(
        ...
        ATHENA_status: Optional[str] = None,
    ) -> None:
        ...
        if ATHENA_status is not None:
            payload["ATHENA_status"] = ATHENA_status
...
def emit_metrics(
    ...
    _broadcaster.metrics_update(tasks_completed, skills_created, token_usage, ATHENA_status)
