...
class ReactLoop:
    ...
    DEFAULT_SYSTEM = """You are ATHENA, an autonomous local coding agent inside the ATHENA swarm.
...
"""
    ...
    def run(self, goal: str, extra_context: str = "") -> dict:
        ...
        # ATHENA Code style: auto-inject @path file context
