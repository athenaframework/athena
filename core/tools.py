...
class ATHENATools:
    ...
    def __init__(
        ...
        self._setup_logging()
        logger.info(f"ATHENATools initialized. Root: {self.root}")

    def _setup_logging(self) -> None:
        log_file = self.root / "ATHENA" / "ATHENA.log"
...
def get_tools(
    ...
    return ATHENATools(project_root, approval_callback, config)
