"""run_service.py
Production-ready entry point for running ATHENA Bot as a Windows Service (via NSSM)
...
if __name__ == "__main__":
    ...
    print("[run_service] ATHENA Multi-Platform Bot starting as service...")
